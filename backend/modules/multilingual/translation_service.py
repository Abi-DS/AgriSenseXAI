    ...
    def _load_translations(self) -> Dict[str, Dict[str, str]]:
        ...
        return {
            'en': {
                ...
                # Additional UI text for complete coverage
                'agroxai_title': 'AgroXAI - Crop Recommendation System',
                'agroxai_subtitle': 'Get intelligent crop recommendations with explainable AI',
                'simple_mode_title': 'Simple Mode - Select Your Location',
                'simple_mode_description': 'Just select your state and city. We\'ll automatically get weather and soil data!',
                'manual_mode_title': 'Manual Mode - Enter Soil Parameters',
                'manual_mode_description': 'Enter your soil parameters manually for precise recommendations',
                'getting_coordinates': 'Getting location coordinates from WeatherAPI...',
                'getting_recommendations': 'Getting recommendations with AI analysis...',
                'analyzing_ai': 'Analyzing with AI...',
                'model': 'Model',
                'confidence': 'Confidence',
                'importance': 'Importance',
                'why_these_crops': 'Why These Crops?',
                'use_weather_data': 'Use weather data',
                'enable_weather_help': 'Enable to get location-specific weather data',
                'api_status': 'API Status',
                'language_label': 'Language',
                'mode_label': 'Mode',
                'about': 'About',
                'agroxai_name': 'AgroXAI',
                'provides_features': 'provides AI-powered crop recommendations with:',
                'realtime_weather': 'Real-time weather data',
                'soil_analysis': 'Soil parameter analysis',
                'lightgbm_model': 'LightGBM ML model',
                'shap_lime': 'SHAP & LIME explanations',
                'multilingual': 'Multilingual support',
                'self_contained': 'Self-contained app',
                'no_backend': 'No separate backend needed!',
                'weatherapi_configured': 'WeatherAPI: Configured',
                'weatherapi_not_set': 'WeatherAPI: Not set (using fallback)',
                'openweather_configured': 'OpenWeatherMap: Configured',
                'openweather_not_set': 'OpenWeatherMap: Not set',
                'ambee_configured': 'Ambee Soil API: Configured',
                'ambee_not_set': 'Ambee Soil API: Not set (using estimates)',
                'loading_locations': 'Loading location data...',
                'moisture_percent': 'Moisture %',
                'no_cities_found': 'No cities found for {state}. Check locations.json file.',
                'location_selected_msg': 'Location Selected',
                'positive': '[Positive]',
                'negative': '[Negative]',
                'neutral': '[Neutral]',
                'unknown': 'Unknown'
            ...
            'hi': {
                ...
                'agroxai_title': 'एग्रोएक्सएआई - फसल सुझाव प्रणाली',
                'agroxai_subtitle': 'व्याख्यात्मक AI के साथ बुद्धिमान फसल सुझाव प्राप्त करें',
                'simple_mode_title': 'सरल मोड - अपना स्थान चुनें',
                'simple_mode_description': 'बस अपना राज्य और शहर चुनें। हम स्वचालित रूप से मौसम और मिट्टी डेटा प्राप्त करेंगे!',
                'manual_mode_title': 'मैनुअल मोड - मिट्टी के मापदंड दर्ज करें',
                'manual_mode_description': 'सटीक सुझावों के लिए अपने मिट्टी के मापदंड मैन्युअल रूप से दर्ज करें',
                'getting_coordinates': 'WeatherAPI से स्थान निर्देशांक प्राप्त कर रहे हैं...',
                'getting_recommendations': 'AI विश्लेषण के साथ सुझाव प्राप्त कर रहे हैं...',
                'analyzing_ai': 'AI के साथ विश्लेषण कर रहे हैं...',
                'model': 'मॉडल',
                'confidence': 'आत्मविश्वास',
                'importance': 'महत्व',
                'why_these_crops': 'ये फसलें क्यों?',
                'use_weather_data': 'मौसम डेटा का उपयोग करें',
                'enable_weather_help': 'स्थान-विशिष्ट मौसम डेटा प्राप्त करने के लिए सक्षम करें',
                'api_status': 'API स्थिति',
                'language_label': 'भाषा',
                'mode_label': 'मोड',
                'about': 'के बारे में',
                'agroxai_name': 'एग्रोएक्सएआई',
                'provides_features': 'AI-संचालित फसल सुझाव प्रदान करता है:',
                'realtime_weather': 'वास्तविक समय मौसम डेटा',
                'soil_analysis': 'मिट्टी मापदंड विश्लेषण',
                'lightgbm_model': 'LightGBM ML मॉडल',
                'shap_lime': 'SHAP और LIME स्पष्टीकरण',
                'multilingual': 'बहुभाषी समर्थन',
                'self_contained': 'स्व-निहित ऐप',
                'no_backend': 'अलग बैकएंड की आवश्यकता नहीं!',
                'weatherapi_configured': 'WeatherAPI: कॉन्फ़िगर किया गया',
                'weatherapi_not_set': 'WeatherAPI: सेट नहीं (फॉलबैक का उपयोग)',
                'openweather_configured': 'OpenWeatherMap: कॉन्फ़िगर किया गया',
                'openweather_not_set': 'OpenWeatherMap: सेट नहीं',
                'ambee_configured': 'Ambee मिट्टी API: कॉन्फ़िगर किया गया',
                'ambee_not_set': 'Ambee मिट्टी API: सेट नहीं (अनुमानों का उपयोग)',
                'loading_locations': 'स्थान डेटा लोड हो रहा है...',
                'moisture_percent': 'नमी %',
                'no_cities_found': '{state} के लिए कोई शहर नहीं मिला। locations.json फ़ाइल जांचें।',
                'location_selected_msg': 'स्थान चुना गया',
                'positive': '[सकारात्मक]',
                'negative': '[नकारात्मक]',
                'neutral': '[तटस्थ]',
                'unknown': 'अज्ञात'
            ...
            'ta': {
                ...
                # Additional UI translations
                'agroxai_title': 'அக்ரோஎக்ஸ்ஏஐ - பயிர் பரிந்துரை அமைப்பு',
                'agroxai_subtitle': 'விளக்கக்கூடிய AI உடன் புத்திசாலித்தனமான பயிர் பரிந்துரைகளைப் பெறுங்கள்',
                'simple_mode_title': 'எளிய முறை - உங்கள் இடத்தைத் தேர்ந்தெடுக்கவும்',
                'simple_mode_description': 'உங்கள் மாநிலம் மற்றும் நகரத்தைத் தேர்ந்தெடுக்கவும்। நாங்கள் தானாக வானிலை மற்றும் மண் தரவைப் பெறுவோம்!',
                'manual_mode_title': 'கைமுறை முறை - மண் அளவுருக்களை உள்ளிடவும்',
                'manual_mode_description': 'துல்லியமான பரிந்துரைகளுக்கு உங்கள் மண் அளவுருக்களை கைமுறையாக உள்ளிடவும்',
                'getting_coordinates': 'WeatherAPI இலிருந்து இடம் ஆயத்தொலைவுகளைப் பெறுகிறது...',
                'getting_recommendations': 'AI பகுப்பாய்வுடன் பரிந்துரைகளைப் பெறுகிறது...',
                'analyzing_ai': 'AI உடன் பகுப்பாய்வு செய்கிறது...',
                'model': 'மாதிரி',
                'confidence': 'நம்பிக்கை',
                'importance': 'முக்கியத்துவம்',
                'why_these_crops': 'இந்த பயிர்கள் ஏன்?',
                'use_weather_data': 'வானிலை தரவைப் பயன்படுத்தவும்',
                'enable_weather_help': 'இடம்-குறிப்பிட்ட வானிலை தரவைப் பெற இயக்கவும்',
                'api_status': 'API நிலை',
                'language_label': 'மொழி',
                'mode_label': 'முறை',
                'about': 'பற்றி',
                'agroxai_name': 'அக்ரோஎக்ஸ்ஏஐ',
                'provides_features': 'AI-இயக்கப்பட்ட பயிர் பரிந்துரைகளை வழங்குகிறது:',
                'realtime_weather': 'நேரடி வானிலை தரவு',
                'soil_analysis': 'மண் அளவுரு பகுப்பாய்வு',
                'lightgbm_model': 'LightGBM ML மாதிரி',
                'shap_lime': 'SHAP மற்றும் LIME விளக்கங்கள்',
                'multilingual': 'பல மொழி ஆதரவு',
                'self_contained': 'சுய-கொண்ட பயன்பாடு',
                'no_backend': 'தனி பேக்எண்ட் தேவையில்லை!',
                'weatherapi_configured': 'WeatherAPI: கட்டமைக்கப்பட்டது',
                'weatherapi_not_set': 'WeatherAPI: அமைக்கப்படவில்லை (விசாரணையைப் பயன்படுத்துகிறது)',
                'openweather_configured': 'OpenWeatherMap: கட்டமைக்கப்பட்டது',
                'openweather_not_set': 'OpenWeatherMap: அமைக்கப்படவில்லை',
                'ambee_configured': 'Ambee மண் API: கட்டமைக்கப்பட்டது',
                'ambee_not_set': 'Ambee மண் API: அமைக்கப்படவில்லை (மதிப்பீடுகளைப் பயன்படுத்துகிறது)',
                'loading_locations': 'இடம் தரவை ஏற்றுகிறது...',
                'moisture_percent': 'ஈரப்பதம் %',
                'no_cities_found': '{state} க்கு எந்த நகரங்களும் கிடைக்கவில்லை। locations.json கோப்பைச் சரிபார்க்கவும்.',
                'location_selected_msg': 'இடம் தேர்ந்தெடுக்கப்பட்டது',
                'positive': '[நேர்மறை]',
                'negative': '[எதிர்மறை]',
                'neutral': '[நடுநிலை]',
                'unknown': 'அறியப்படாத'
            ...
            'te': {
                ...
                # Additional UI translations
                'agroxai_title': 'అగ్రోఎక్స్ఏఐ - పంట సిఫారసు వ్యవస్థ',
                'agroxai_subtitle': 'వివరణాత్మక AIతో తెలివైన పంట సిఫారసులను పొందండి',
                'simple_mode_title': 'సాధారణ మోడ్ - మీ స్థానాన్ని ఎంచుకోండి',
                'simple_mode_description': 'మీ రాష్ట్రం మరియు నగరాన్ని ఎంచుకోండి. మేము స్వయంచాలకంగా వాతావరణ మరియు నేల డేటాను పొందుతాము!',
                'manual_mode_title': 'మాన్యువల్ మోడ్ - నేల పరామితులను నమోదు చేయండి',
                'manual_mode_description': 'ఖచ్చితమైన సిఫారసుల కోసం మీ నేల పరామితులను మాన్యువల్గా నమోదు చేయండి',
                'getting_coordinates': 'WeatherAPI నుండి స్థాన సమన్వయాలను పొందుతోంది...',
                'getting_recommendations': 'AI విశ్లేషణతో సిఫారసులను పొందుతోంది...',
                'analyzing_ai': 'AIతో విశ్లేషిస్తోంది...',
                'model': 'మోడల్',
                'confidence': 'విశ్వాసం',
                'importance': 'ప్రాముఖ్యత',
                'why_these_crops': 'ఈ పంటలు ఎందుకు?',
                'use_weather_data': 'వాతావరణ డేటాను ఉపయోగించండి',
                'enable_weather_help': 'స్థాన-నిర్దిష్ట వాతావరణ డేటాను పొందడానికి ప్రారంభించండి',
                'api_status': 'API స్థితి',
                'language_label': 'భాష',
                'mode_label': 'మోడ్',
                'about': 'గురించి',
                'agroxai_name': 'అగ్రోఎక్స్ఏఐ',
                'provides_features': 'AI-శక్తితో పంట సిఫారసులను అందిస్తుంది:',
                'realtime_weather': 'నిజ-సమయ వాతావరణ డేటా',
                'soil_analysis': 'నేల పరామితి విశ్లేషణ',
                'lightgbm_model': 'LightGBM ML మోడల్',
                'shap_lime': 'SHAP మరియు LIME వివరణలు',
                'multilingual': 'బహుభాషా మద్దతు',
                'self_contained': 'స్వీయ-కలిగిన అనువర్తనం',
                'no_backend': 'ప్రత్యేక బ్యాకెండ్ అవసరం లేదు!',
                'weatherapi_configured': 'WeatherAPI: కాన్ఫిగర్ చేయబడింది',
                'weatherapi_not_set': 'WeatherAPI: సెట్ చేయబడలేదు (ఫాల్బ్యాక్ ఉపయోగిస్తోంది)',
                'openweather_configured': 'OpenWeatherMap: కాన్ఫిగర్ చేయబడింది',
                'openweather_not_set': 'OpenWeatherMap: సెట్ చేయబడలేదు',
                'ambee_configured': 'Ambee నేల API: కాన్ఫిగర్ చేయబడింది',
                'ambee_not_set': 'Ambee నేల API: సెట్ చేయబడలేదు (అంచనాలను ఉపయోగిస్తోంది)',
                'loading_locations': 'స్థాన డేటాను లోడ్ చేస్తోంది...',
                'moisture_percent': 'తేమ %',
                'no_cities_found': '{state} కోసం నగరాలు కనుగొనబడలేదు. locations.json ఫైల్ను తనిఖీ చేయండి.',
                'location_selected_msg': 'స్థానం ఎంచుకోబడింది',
                'positive': '[సానుకూల]',
                'negative': '[ప్రతికూల]',
                'neutral': '[తటస్థ]',
                'unknown': 'తెలియదు'
